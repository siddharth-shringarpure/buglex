...
This document lists dependencies and their associated versions required to run semlex and collate results.
...
\begin{verbatim}
      Please use the official uv documentation linked below for install instructions
\end{verbatim}
